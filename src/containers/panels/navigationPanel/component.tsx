        ...
        {this.state.searchState ? (
          ...
          <>
            <div className="navigation-header">
              {/* ① 最顶端：退出 / 书签 / 全屏 三个按钮排成一行。
                  原先浮在屏幕顶部会压住正文，现迁到左侧面板最上方。 */}
              {this.props.htmlBook && (
                <div className="navigation-operation-slot">
                  <OperationPanel
                    {...({
              ...
              {/* ② 图书信息（封面 + 书名 + 作者 + 阅读时长 + 锁） */}
              <div className="navigation-book-info">
                <span
                  className={
