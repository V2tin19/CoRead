...
class UpdateInfo extends React.Component<UpdateInfoProps, UpdateInfoState> {
  ...
  async componentDidMount() {
    // CoRead 不走上游的更新通道。原实现会去 api.koodoreader.com 查版本，
    // 一旦"发现新版本"，点【下载】就从 dl.koodoreader.com 拉回 Koodo Reader
    // 的安装包、把本应用覆盖掉。所以应用内更新检查整体停用 ——
    // 新版本改由 GitHub Release 手动分发（「关于」页给的是 Release 链接）。
    return;
  }
  renderList = (arr: any[]) => {
